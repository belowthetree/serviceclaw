            ...
            ? renderServicesView({
                ...
                onServiceRun: (serviceId) => {
                  ...
                  if (service) {
                    ...
                    import("../services/lifecycle-sync.js")
                      .then(({ openServiceModal }) => {
                        console.log(
                          "[app-render] lifecycle-sync imported, calling openServiceModal...",
                        );
                        void openServiceModal(serviceId, service.name, state.client ?? undefined);
                      })
                      .catch((err) => {
